...
ggsave("outputs/tract-2011to2015-exhibit-4.png", width = 8, height = 4, units = "in", device = "png")
...
ggsave("outputs/tract-2011to2015-exhibit-5.png", width = 8, height = 4, units = "in", device = "png")
